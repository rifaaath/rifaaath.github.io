    ...
    <main className="flex-grow flex flex-col items-center justify-start container mx-auto p-4 sm:p-6 md:p-8 text-foreground min-h-screen">
      ...
      <footer className="text-center mt-10 mb-6 py-6">
        <p className="text-xs text-muted-foreground">
          <a class="flex items-center justify-center">With<svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" class="mx-2" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M4 1c2.21 0 4 1.755 4 3.92C8 2.755 9.79 1 12 1s4 1.755 4 3.92c0 3.263-3.234 4.414-7.608 9.608a.513.513 0 0 1-.784 0C3.234 9.334 0 8.183 0 4.92 0 2.755 1.79 1 4 1"></path></svg>From MHG Erlangen</a>
        </p>
